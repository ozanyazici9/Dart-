...
* Bu işareti kullanınca şunu demiş olursunuz : değer null olmayacak bu yüzden bu değeri
non-nullable bir değişkene atabilirsiniz.
*
* Eğer bu düşüncenizde hatalıysanız/haksızsanız dart run-timeda bir hata fırlatır.
Böylece programımız null hatalarına açılmış olur bu yüzden yüzde yüz kodunuzun null
...
veriyorum ki null değer yok, o yüzden bunu null değer kabul etmeyen bir değişkene
atayabilirsin.
*
